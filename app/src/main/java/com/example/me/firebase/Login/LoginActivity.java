...
import com.example.me.firebase.Var;
...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inputEmail = (EditText) findViewById(R.id.edt_user_name);
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Var.saveEmail(LoginActivity.this,KEY_EMAIL,password);
                Log.d("key_emailll",Var.getEmail(LoginActivity.this));
